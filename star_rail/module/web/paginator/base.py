...
class Paginator(typing.Generic[T], abc.ABC):
    ...
    def __repr__(self) -> str:
        kwargs = ", ".join(
            f"{name}={getattr(self, name, 'undefined')!r}" for name in self._repr_attributes
        )
        return f"{self.__class__.__name__}({kwargs})"

    def __pretty__(self, fmt: typing.Callable[[typing.Any], str]) -> typing.Iterator[typing.Any]:
...
class MergedPaginator(typing.Generic[T], Paginator[T]):
    ...
    def _create_heap_item(
        ...
        return sort_value, value, iterator
    ...
    async def _prepare(self) -> None:
        ...
        for it, value in zip(self.iterators, first_values):
            ...
            heapq.heappush(self._heap, self._create_heap_item(value, iterator=it))
        self._prepared = True
    ...
    async def __anext__(self) -> T:
        ...
        heapq.heapreplace(self._heap, self._create_heap_item(new_value, iterator=it))
