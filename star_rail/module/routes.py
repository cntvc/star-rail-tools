...
MULTI_TOKEN_BY_LOGINTICKET_URL = Route(
...
MONTH_INFO_URL = Route("https://api-takumi.mihoyo.com/event/srledger/month_info")
"""[米游社] 开拓月历"""

MONTH_DETAIL_URL = Route("https://api-takumi.mihoyo.com/event/srledger/month_detail")
"""[米游社] 开拓月历详情"""
