"""
Copy from https://github.com/pdm-project/pdm-backend
"""
...
class _Version(typing.NamedTuple):
    epoch: int
    release: tuple[int, ...]
    dev: typing.Optional[tuple[str, int]]
    pre: typing.Optional[tuple[str, int]]
    post: typing.Optional[tuple[str, int]]
    local: typing.Optional[LocalType]
