...
class TestVersion(unittest.TestCase):
    def test_compare_version(self):
        ...
        self.assertEqual(compare_versions("100.10.2", "100.10.1"), 1)
        self.assertEqual(compare_versions("1.1.1.dev2", "1.1.1.dev1"), 1)
        self.assertEqual(compare_versions("1.1.2.dev1", "1.1.1.dev1"), 1)
        self.assertEqual(compare_versions("1.1.1", "1.1.1.dev1"), 1)
        self.assertEqual(compare_versions("1.1.2", "1.1.1.dev1"), 1)
